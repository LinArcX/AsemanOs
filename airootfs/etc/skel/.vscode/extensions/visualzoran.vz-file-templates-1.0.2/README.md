...
![Template selection](https://github.com/visualzoran/vz-file-templates/raw/master/resources/NewFileFromTemplate.gif)
...
![Creating new template from template](https://github.com/visualzoran/vz-file-templates/raw/master/resources/newTemplate.gif)
...
* "openFiles" - names of files that should be opened after template processing is finished. It can be used to specify files generated by external command
